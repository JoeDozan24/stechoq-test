module.exports = {
    ...
    create: function(conn, data, callback) {
        conn.query("INSERT INTO mata_kuliah SET kode_mata_kuliah = '" + data.kode_mata_kuliah +"', nama = '" + data.nama + "', sks = '" + data.sks + "', kode_program_studi = '" + data.kode_program_studi + "'", callback);
    },
    
    update: function(conn, data, id, callback) {
        conn.query("UPDATE mata_kuliah SET kode_mata_kuliah = '" + data.kode_mata_kuliah + "', nama = '" + data.nama + "', sks = '" + data.sks + "', kode_program_studi = '" + data.kode_program_studi + " WHERE kode_mata_kuliah = '" + id + "'", callback)
    },
